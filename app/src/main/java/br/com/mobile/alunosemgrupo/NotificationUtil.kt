...
object NotificationUtil {
    ...
    fun create(id: Int, intent: Intent, titulo: String, texto: String) {
        ...
        val contexto = FlagApplication.getInstance().applicationContext
        // criar canal para mostrar notificação
        createChannel(FlagApplication.getInstance())
        ...
        with(NotificationManagerCompat.from(FlagApplication.getInstance())) {
            val n = builder.build()
            notify(id, n)
        }
    }
